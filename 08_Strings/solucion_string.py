# Crea una variable llamada mi_texto con el siguiente valor: 'Estoy aprendiendo Python, ¡y me está encantando'.
...
# Realiza un print de ```mi_texto``` y coloca sólo el primer carácter en mayúscula.
...
# Trocea ```mi_texto``` desde la posición 10 a la 20 y lo muestras por pantalla usando print.
...
# Crea una variable lista_mi_texto y que se guarde el resultado de usar el método split sobre ```mi_texto```.
