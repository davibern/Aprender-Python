...
'''
Crea una variable llamada temperatura y la inicializas a 21.
Si es mayor de 0 y menor o igual de 10: Hace mucho frío si está entre 11 y 20
Si está entre 21 y : Hace algo de frío
Si está entre 31 y 40: Hay temperatura cálida
Si es mayor de 40: Vamos a morir!!!
'''
temperatura = 21
...
'''
Crea una variable llamada edad y aplícale un input para solicitar la edad
Si el usuario tiene 18 años o más indica que puede sacarse el carnet
si no, calcula los años que faltan para poder hacerlo.
Tendrás que validar si la edad introducida por el usuario es un número 😜
y además convertir el dato a número...
'''
...
'''
Tienes la siguiente lista de colores ['blanco', 'rojo', 'azul'].
Vas a añadir el color azul, pero antes tienes que comprobar si existe la lista.
