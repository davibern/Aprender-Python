...
# Crea una función con dos argumentos que se llame multiplicación
...
# Crea una función que se llame resto y que calcule el resto de dos números
# (éstos deben pasarse como parámetros).
...
# Crea una función que se llame mi_lista y que calcule el número de elementos
# que tiene y que los muestre por pantalla.
...
# Crea una función que se llame suma_total y que tenga parámetros arbitrarios,
# y que devuelva la suma de todos los elementos.
...
'''
Declara una función que se llame caja. Tendrá dos argumentos: entrada, valor.
Y funcionará de la siguiente manera:
* entrada tendrá como valores "entrada" o "salida".
* valor tendrá como valor un número.
* dentro de la función habrá una variable llamada total inicializada a 1000.
* si el argumento entrada es entrada se le sumará a total lo indicado en valor.
* si el argumento entrada es salida se restará al total lo indicado en valor.
...
# Crea una función es_par_impar(), recibirá como argumento un número,
# y devolverá par si es par o impar si es impar.
...
'''
Crea una función que servirá para adivinar un número aleatorio.
Este número aleatorio estará comprendido entre 1 y un máximo que se
indicará como argumento de nuestra función. El usuario tendrá que ir añadiendo
números hasta dar con el aleatorio, para ello habrá que ayudarle
...
def adivinar_numero_aleatorio(maximo):
    ...
    numero_a_adivinar = 0
    texto = 'Adivina un número entre 1 y '

    while numero_a_adivinar != aleatorio:
        numero_a_adivinar = int(input(f'{texto} y {maximo}: '))
